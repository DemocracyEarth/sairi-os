        ...
        component: {
          ...
          props: {
            ...
            items: [
              ...
              { label: 'VM image', state: 'ok', detail: 'Builds, boots, reaches the desktop' },
              {
                label: 'OpenClaw provider',
                state: 'warn',
                detail: 'Pinned and installed; wire protocol unverified',
              },
              {
                label: 'Capabilities',
                state: 'warn',
                detail: '3 of 11 real, the rest simulated',
              },
            ],
          },
        },
      },
      {
        ...
        component: {
          ...
          props: {
            title: 'Next up',
            items: [
              { id: 'boot', label: 'Boot the VM image end to end', checked: true },
              { id: 'gateway', label: 'Meet a live OpenClaw gateway', checked: false },
              { id: 'ci', label: 'Add CI: make validate plus a boot smoke test', checked: false },
              { id: 'revoke', label: 'Let a granted permission be revoked', checked: false },
        ...
        component: {
          ...
          props: {
            ...
            items: [
              ...
              { key: 'ADR-0010', value: 'The provider key is held, never read back, never used' },
            ],
          },
        },
      },
